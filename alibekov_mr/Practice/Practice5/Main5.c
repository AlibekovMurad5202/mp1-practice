...
void main() 
{
    ...
    do
    {
        ...
        do {
            ...
            switch (choose)
            {
            case 1: time_begin = clock();
                    Choose_Sort(a, cof);
                    time_end = clock();
                    break;
            case 2: time_begin = clock();
                    Insert_Sort(a, cof);
                    time_end = clock();
                    break;
            case 3: time_begin = clock();
                    Bubble_Sort(a, cof);
                    time_end = clock();
                    break;
            case 4: time_begin = clock();
                    Counting_Sort(a, cof);
                    time_end = clock();
                    break;
            case 5: time_begin = clock();
                    Quick_Sort(a, 0, cof - 1);
                    time_end = clock();
                    break;
            case 6: time_begin = clock();
                    Merge_Sort(a, 0, cof);
                    time_end = clock();
                    break;
            }
